...
export const metadata = { title: "Yönetim girişi — MyVisa" };
      ...
      <div style={{ width: 420, maxWidth: "100%", position: "relative" }}>
        ...
        <div className="mv-pop" style={{ background: "#fff", borderRadius: 24, padding: "34px 32px", boxShadow: "0 30px 70px rgba(3,12,28,.45)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
            <span style={{ width: 34, height: 34, borderRadius: 9, background: "#ecfdf5", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <Icon name="users" size={18} stroke="#10b981" width={2.2} />
            </span>
            <h1 style={{ fontSize: 21, fontWeight: 800, color: "#0A1F3C", margin: 0, letterSpacing: "-.01em" }}>
              Yönetim paneli
            </h1>
          </div>
