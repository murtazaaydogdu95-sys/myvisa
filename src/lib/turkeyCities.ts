// Turkey provinces (il) → districts (ilçe). Used for the cascading
// Şehir (province) / İlçe (district) address selects in the apply wizard.
export const turkeyProvinces: Record<string, string[]> = {
...
export const turkeyProvinceNames = Object.keys(turkeyProvinces).sort((a, b) => a.localeCompare(b, "tr"));
